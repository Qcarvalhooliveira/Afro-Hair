...
const products: Product[] = [
 ...
 
  {
    ...
    action: 'Aloe Vera is a moisturizing agent that provides shine and softness to the hair.',
    activeIngredients: 'Aloe Vera (Aloe barbadensis) and Hydrovance.',
    benefits: 'Hydrovance is an active ingredient that works on the hair fiber from the cuticle to the core, providing hydration, repair, strengthening, improved feel, frizz & volume control, natural look, and softness.',
    composition: 'AQUA (Water), CETEARYL ALCOHOL, ZEA MAYS STARCH (Corn Starch), BUTYROSPERMUM PARKII BUTTER (Shea Butter), GLYCINE SOJA OIL (Soybean Oil), CETRIMONIUM CHLORIDE, BENZYL ALCOHOL, PARFUM (Perfume), ALCOHOL, HYDROXYETHYL UREA, BENZOIC ACID, BHT, CETEARETH-60 MYRISTYL GLYCOL, ALOE BARBADENSIS LEAF EXTRACT (Aloe Vera Leaf Extract), HEXYL CINNAMAL, SORBIC ACID, LINALOOL, BUTYLPHENYL METHYLPROPIONAL, SORBITOL, D-LIMONENE, TOCOPHERYL ACETATE, LACTIC ACID, POTASSIUM SORBATE, SODIUM BENZOATE.',
    price: 9.99,
  },

 {
    ...
    
      {
        ...
        category:["Conditioner", "best Seller"],
        indication: 'Recommended for curly, dry, oily, combination, chemically treated, and dyed hair.',
...

      {
        ...
        activeIngredients: 'Pure Oils: Argan, Coconut, Flaxseed, Sunflower, Avocado, and Olive',
        benefits: 'Soft, silky, and lively hair. Wonderful perfume and radiating shine.',
        composition: 'AQUA (Water), CETEARYL ALCOHOL, BUTYROSPERMUM PARKII BUTTER (Shea Butter), ZEA MAYS STARCH (Corn Starch), CETRIMONIUM CHLORIDE, GLYCINE SOJA OIL (Soybean Oil), PARFUM (Perfume), BENZYL ALCOHOL, ALCOHOL, HYDROXYETHYL UREA, HEXYL CINNAMAL, DISODIUM EDTA, BENZOIC ACID, BHT, CETEARETH-60 MYRISTYL GLYCOL, HYDROXYCITRONELLAL, SORBIC ACID, LINALOOL, D-LIMONENE, LACTIC ACID, HELIANTHUS ANNUUS SEED OIL (Sunflower Seed Oil), HYDROLYZED WHEAT PROTEIN, HYDROLYZED SOY PROTEIN, HYDROLYZED CORN PROTEIN, LINUM USITATISSIMUM SEED OIL (Flaxseed Oil), COCOS NUCIFERA OIL (Coconut Oil), PHENOXYETHANOL, OLEA EUROPAEA FRUIT OIL (Olive Oil), PERSEA GRATISSIMA OIL (Avocado Oil), ARGANIA SPINOSA KERNEL OIL (Argan Oil), MACADAMIA TERNIFOLIA SEED OIL, ROSMARINUS OFFICINALIS LEAF EXTRACT (Rosemary Leaf Extract).',
        price: 9.99,
      },
...

      {
        ...
        category:["Leave-In"],
        indication: 'Recommended for curly, dry, oily, combination, chemically treated, or dyed hair.',
...

      {
        ...
        action: 'Hair super hydrated, revitalized, and shiny. You with an extra dose of power!',
        activeIngredients: 'Aloe Vera and Hydrovance.',
        benefits: 'Aloe Vera is a hydrating active ingredient that provides shine and softness to the hair.',
        price:24.99,
...

      {
        ...
        activeIngredients: 'Olive Oil and Rosemary.',
        benefits: 'Penetrates deeply into the hair fiber, providing deep hydration, nourishment, softness, and protection.',
        price:24.99,
...

      {
        ...
        category:["Kit"],
        indication: 'Recommended for curly, dry, oily, combination, chemically treated, dyed, dull, split ends, and frizzy hair.',
        action: 'Hydrated, soft, shiny hair without split ends, knots, or frizz.',
        activeIngredients: 'Baobab Seed Oil.',
        benefits: 'Ideal for curly hair suffering from dryness and easily absorbed, Baobab Seed Oil stands out for its highly moisturizing action and fantastic emollient power.',
        price:24.99,
      ...
      
      {
        ...
        category:["Kit"],
        indication: 'Recommended for curly, dry, combination, chemically treated, and colored hair.',
        action: 'You empowered to shine.',
        activeIngredients: 'Coconut Oil.',
        benefits: 'We all know that coconut water is a wonder. The delicious coconut pulp is no secret either. Besides that, coconut oil brings many benefits to the health and beauty of hair.',
        price:24.99,
...

      {
        ...
        activeIngredients: 'Aloe Vera and Hydrovance.',
        benefits: 'Aloe Vera is a moisturizing agent that provides shine and softness to the hair. Hydrovance is an active ingredient that acts on the hair fiber from the cuticle to the medulla, providing hydration, repair, strengthening, improved sensory feel, frizz & volume control, natural appearance, and softness.',
        composition: 'AQUA, CETEARYL ALCOHOL, ZEA MAYS STARCH, BUTYROSPERMUM PARKII BUTTER, GLYCINE SOJA OIL, CETRIMONIUM CHLORIDE, BENZYL ALCOHOL, PARFUM, ALCOHOL, HYDROXYETHYL UREA, BENZOIC ACID, BHT, CETEARETH-60 MYRISTYL GLYCOL, ALOE BARBADENSIS LEAF EXTRACT, HEXYL CINNAMAL, SORBIC ACID, LINALOOL, BUTYLPHENYL METHYLPROPIONAL, SORBITOL, D-LIMONENE, TOCOPHERYL ACETATE, LACTIC ACID, POTASSIUM SORBATE, SODIUM BENZOATE.',
        price:12.99,
      },

      {
        ...
        composition: 'AQUA (WATER), CETEARYL ALCOHOL, BUTYROSPERMUM PARKII BUTTER (SHEA BUTTER), ZEA MAYS STARCH (CORN STARCH), GLYCINE SOJA OIL (SOYBEAN OIL), GLYCERIN, CETRIMONIUM CHLORIDE, BENZYL ALCOHOL, ALCOHOL, PARFUM (FRAGRANCE), HYDROXYETHYL UREA, PROPYLENE GLYCOL, BENZOIC ACID, BHT, OLEA EUROPAEA FRUIT OIL (OLIVE OIL), CETEARETH-60 MYRISTYL GLYCOL, SORBIC ACID, HEXYL CINNAMAL, ROSMARINUS OFFICINALIS LEAF EXTRACT (ROSEMARY LEAF EXTRACT), BENZYL SALICYLATE, LINALOOL, TOCOPHERYL ACETATE (VITAMIN E ACETATE), LACTIC ACID, CI 15510 (ORANGE COLORANT 15510), PHENOXYETHANOL, SODIUM SULFATE, CI 47005 (QUINOLINE YELLOW ALUMINUM LAKE), CI 42090 (BRIGHT BLUE), CI 19140 (TARTRAZINE YELLOW).',
        price: 12.99,
      },

      {
        ...
        activeIngredients: 'Baobab Seed Oil.',
        benefits:'Ideal for curly hair suffering from dryness and easily absorbed, Baobab Seed Oil is renowned for its highly moisturizing action and fantastic emollient power.', 
        composition:'AQUA, CETEARYL ALCOHOL, ZEA MAYS STARCH, BUTYROSPERMUM PARKII BUTTER, CETRIMONIUM CHLORIDE, GLYCINE SOJA OIL, PARFUM, BENZYL ALCOHOL, ALCOHOL, HYDROXYETHYL UREA, CETEARETH-60 MYRISTYL GLYCOL, BENZOIC ACID, BHT, D-LIMONENE, HEXYL CINNAMAL, SORBIC ACID, LINALOOL, BUTYLPHENYL METHYLPROPIONAL, CITRONELLOL, LACTIC ACID, ADANSONIA DIGITATA OIL.', 
        price: 12.99,
      },

      {
        ...
        benefits:'Nutrition, Hydration, Revitalization, Softness, Protection, and Shine.',
        composition: 'AQUA (WATER), CETEARYL ALCOHOL, BUTYROSPERMUM PARKII BUTTER (SHEA BUTTER), ZEA MAYS STARCH (CORN STARCH), GLYCINE SOJA OIL (SOYBEAN OIL), GLYCERIN, CETRIMONIUM CHLORIDE, BENZYL ALCOHOL, PARFUM (FRAGRANCE), ALCOHOL, HYDROXYETHYL UREA, BENZOIC ACID, BHT, COCOS NUCIFERA OIL (COCONUT OIL), CETEARETH-60 MYRISTYL GLYCOL, SORBIC ACID, LINALOOL, LACTIC ACID, TOCOPHERYL ACETATE.',
        price: 12.99,
      },

      {
        ...
        category:["Treatment"],
        indication: 'Recommended for curly, dry, oily, combination, chemically treated, and dyed hair.',
        action: 'You smile once again and continue looking beautiful, confident, and powerful. ',
        activeIngredients: 'Purest Oils: Argan, Coconut, Flaxseed, Sunflower, Avocado, and Olive.',
        benefits: 'Soft, hydrated, silky, and vibrant hair. Wonderful fragrance and radiant shine.',
        composition: 'AQUA, CETEARYL ALCOHOL, BUTYROSPERMUM PARKII BUTTER, ZEA MAYS STARCH, CETRIMONIUM CHLORIDE, GLYCINE SOJA OIL, PARFUM, BENZYL ALCOHOL, ALCOHOL, HYDROXYETHYL UREA, HEXYL CINNAMAL, DISODIUM EDTA, BENZOIC ACID, BHT, CETEARETH-60 MYRISTYL GLYCOL, HYDROXYCITRONELLAL, SORBIC ACID, LINALOOL, D-LIMONENE, LACTIC ACID, HELIANTHUS ANNUUS SEED OIL, HYDROLYZED WHEAT PROTEIN, HYDROLYZED SOY PROTEIN, HYDROLYZED CORN PROTEIN, LINUM USITATISSIMUM SEED OIL, COCOS NUCIFERA OIL, PHENOXYETHANOL, OLEA EUROPAEA FRUIT OIL, PERSEA GRATISSIMA OIL, ARGANIA SPINOSA KERNEL OIL, MACADAMIA TERNIFOLIA SEED OIL, ROSMARINUS OFFICINALIS LEAF EXTRACT.',
        price: 12.99,
...

      {
        ...
        action: 'Hydrates and defines curls, controlling volume and reducing frizz. ',
        activeIngredients: 'With a blend of Nutrifunctional Oils and Cranberry Extract.',
        benefits: 'Curly hair requires a lot of hydration, so Novex has combined 6 nutrifunctional oils into one product:Olive, Argan, Ojon, Monoi, Coconut, and Shea.',
        composition: 'AQUA, CETEARYL ALCOHOL, BUTYROSPERMUM PARKII BUTTER, ZEA MAYS STARCH, GLYCINE SOJA OIL, CETRIMONIUM CHLORIDE, BENZYL ALCOHOL, PARFUM, ALCOHOL, HYDROXYETHYL UREA, BENZOIC ACID, BHT, CETEARETH-60 MYRISTYL GLYCOL, SORBIC ACID, HEXYL CINNAMAL, LACTIC ACID, TOCOPHERYL ACETATE, HELIANTHUS ANNUUS SEED OIL, GLYCERIN, LINUM USITATISSIMUM SEED OIL, COCOS NUCIFERA OIL, OLEA EUROPAEA FRUIT OIL, PERSEA GRATISSIMA OIL, ARGANIA SPINOSA KERNEL OIL, MACADAMIA TERNIFOLIA SEED OIL, LYCIUM BARBARUM FRUIT EXTRACT, VACCINIUM MYRTILLUS FRUIT EXTRACT, VACCINIUM MACROCARPON FRUIT EXTRACT, ROSMARINUS OFFICINALIS LEAF EXTRACT, SODIUM BENZOATE, POTASSIUM SORBATE.',
        price: 12.99,
      },
...

      {
        ...
        category:["Shampoo"],
        indication: 'Suitable for curly, dry, oily, combination, chemically treated, and dyed hair.',
        action: 'Hydrated curls, free of split ends, with shine and volume.',
        activeIngredients: 'Baobab Seed Oil.',
        benefits: 'Completely free: no parabens, petrolatum, silicones, and sulfates.',
        composition:'LAQUA, DISODIUM LAURETH SULFOSUCCINATE, COCAMIDE DEA, COCAMIDOPROPYL BETAINE, GLYCERIN, LAURYL GLUCOSIDE, GUAR HYDROXYPROPYLTRIMONIUM CHLORIDE, PARFUM, PEG/PPG-120/10 TRIMETHYLOLPROPANE TRIOLEATE, LAURETH-2, GLYCOL DISTEARATE, BENZYL ALCOHOL, PHENOXYETHANOL, POLYQUATERNIUM-7, COCO-GLUCOSIDE, DISODIUM EDTA, POTASSIUM CHLORIDE, CHLORPHENESIN, SODIUM BENZOATE, BHT, GLYCERYL STEARATE, GLYCERYL OLEATE, D-LIMONENE, HEXYL CINNAMAL, LINALOOL, BUTYLPHENYL METHYLPROPIONAL, CITRIC ACID, BENZOIC ACID, ADANSONIA DIGITATA OIL.',
        price: 9.99,
...

      {
        ...
        action: 'Hair super hydrated, soft, and with a lot of shine.',
        activeIngredients: 'Coconut Oil.',
        benefits: 'That coconut water is a wonder, we all know. That coconut pulp is delicious, it has no secret to anyone.',
